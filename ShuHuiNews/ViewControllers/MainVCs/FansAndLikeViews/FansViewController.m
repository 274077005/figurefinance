...
- (void)getListData
{
    ...
    [GYPostData GetInfomationWithDic:bodyDic UrlPath:JFansList Handler:^(NSDictionary *jsonDic, NSError * error) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if([model.status isEqualToString:@"1"]){
        ...
        [cell.controllBtn setTitle:@"关注" forState:UIControlStateNormal];
        [cell.controllBtn setTintColor:RGBCOLOR(14, 124, 244)];
        cell.controllBtn.layer.borderColor = RGBCOLOR(14, 124, 244).CGColor;
    }
...
- (void)controllerBtnClick:(UIButton *)btn
{
    ...
    [bodyDic setObject:model.status forKey:@"status"];
