...
+ (instancetype)initilzerProgressViewWithFrame:(CGRect)frame {
    ...
    [progressView setThumbImage:[UIImage imageNamed:@"circular"] forState:UIControlStateNormal];
    [progressView setMinimumTrackImage:[UIImage imageNamed:@"line"] forState:UIControlStateNormal];
...
- (void)setup {
    ...
    self.bufferTintColor = [UIColor whiteColor];
    ...
    self.bufferProgressTintColor = [UIColor colorWithWhite:0.5 alpha:0.6];
    self.progressWidth = 2.0;
    ...
    self.bufferProgressLayer.lineWidth = 1;
