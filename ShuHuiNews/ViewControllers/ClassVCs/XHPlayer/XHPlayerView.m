...
{
    if (!_clickTimer) {
        _clickTimer = [NSTimer scheduledTimerWithTimeInterval:3.0
                                                       target:self
        ...
        if (fabs([self.clickTimer.fireDate timeIntervalSinceNow]) < 3.0)
            [self.clickTimer setFireDate:[NSDate dateWithTimeIntervalSinceNow:3.0]];
    }
}
