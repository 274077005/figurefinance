...
@property (nonatomic)        NSInteger   rangeFrom; //显示开始下标(表示图从哪个点贴到截面上)
@property (nonatomic)        NSInteger   rangeTo; //显示结束下标
@property (nonatomic)        NSInteger   range; //显示条数
...
@property (nonatomic)        NSInteger   nowOrDay; //999则表示区块链 用来区别颜色 0则是分时图
//用来确定分时图字的位置
@property (nonatomic)        NSInteger   whetherRevolve;
