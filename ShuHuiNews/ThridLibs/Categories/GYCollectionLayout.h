...
@class GYCollectionLayout;
@protocol GYCollectionLayoutDelegate <NSObject>
@required
// item width
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(GYCollectionLayout*)collectionViewLayout referenceSizeForFooterInSection:(NSInteger)section;
@end

@interface GYCollectionLayout : UICollectionViewLayout

@property (nonatomic, weak) id<GYCollectionLayoutDelegate> delegate;
