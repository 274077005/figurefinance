...
@interface GYTimer ()
@property (nonatomic,weak) id<GYTimerDelegate> delegate;
...
- (void)startGCDTimer:(NSTimeInterval)seconds
    ...
    dispatch_source_set_event_handler(self.gcdTimer, ^{
        ...
        if (self.delegate && [self.delegate respondsToSelector:@selector(onTimerClick:)]) {
            
            [self.delegate onTimerClick:self];
