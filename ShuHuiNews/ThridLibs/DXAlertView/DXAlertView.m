...
#define Color_Red                               UIColorFromRGB(0xfc8d1f)
   ...
   rightButtonTitle:(NSString *)rigthTitle
{
    ...
    if (self) {
        ...
        [self.rightBtn setBackgroundImage: [UIImage imageWithColor:RGBCOLOR(14, 124, 244)] forState:UIControlStateNormal];
        [self.leftBtn setBackgroundImage: [UIImage imageWithColor:RGBCOLOR(202,202, 202)] forState:UIControlStateNormal];
