...
- (void)showFirstImage
{
    ...
    if ([self highQualityImageURLForIndex:self.currentImageIndex]) {
        
        [tempView sd_setImageWithURL:[self highQualityImageURLForIndex:self.currentImageIndex]  placeholderImage:[self placeholderImageForIndex:self.currentImageIndex]];
    } else {
        tempView.image = [self placeholderImageForIndex:self.currentImageIndex];
    }
